 ...
 */
internal object LegacyBarnardSigning {
    ...
    fun backendCompressedPublicKey(privateKey: BigInteger): ByteArray? =
        if (privateKey.signum() > 0 && privateKey < N) compress(scalarMult(privateKey, G)) else null
